   ...
   <!-- <script type="text/javascript" src="/capcc0624/Public/Admin/nav.js"></script>-->
    ...
    <script language="JavaScript" >
        ...
        function del(id)
        {
            ...
            if (confirm('确认删除?'))
            {
                document.location.href="<?php echo U('News/delete_news');?>?tag=active&id="+del_id;
            }
        }
        ...
        function edit(id)
        {
            ...
            if (confirm('跳转至编辑窗口？'))
            {
                document.location.href="<?php echo U('News/edit_news');?>?tag=active&id="+del_id;
            }
        }
    </script>
</head>
...
<div id="mainDiv">
    <div id="centerDiv">
        ...
        <div id="right">
            <div id="current">&nbsp;&nbsp;&nbsp;&nbsp;当前位置:新闻 动态 列表</div>
            <div id="form">
                <table width="100%" style="text-align: center" >
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center"><?php echo ($vo["oriauthor"]); ?></td>
                            <td align="center"><?php echo ($vo["author"]); ?></td>
                            <td align="center"><?php echo ($vo["editor"]); ?></td>
                            <td align="center"><?php echo ($vo["pubtime"]); ?></td>
                ...
                <div style="font-size: 15px;margin-top: 20px">
                    ...
                    <br />
                    <br />
                    <a href="<?php echo U('News/add','tag=active');?>"><h2>添加一条动态新闻</h2></a>
                </div>
            </div>
