  ...
  <!--  <script type="text/javascript" src="/capcc0624/Public/Admin/nav.js"></script>-->
    ...
    <script language="JavaScript" >
        function del(id)
        {
            ...
            if (confirm('确认删除?'))
            {
                document.location.href="<?php echo U('Travel/delete_travel');?>?tag=story&id="+del_id;
            }
        }
        ...
        function edit(id)
        {
            ...
            if (confirm('跳转至编辑窗口？'))
            {
                document.location.href="<?php echo U('Travel/edit_travel');?>?tag=story&id="+del_id;
            }
        }
    </script>
</head>
...
<div id="mainDiv">
    <div id="centerDiv">
        ...
        <div id="right">
            <div id="current">&nbsp;&nbsp;当前位置:美术馆 艺术群 列表</div>
            <div id="form">
                ...
                <div style="font-size: 15px;margin-top: 20px">
                    ...
                    <br />
                    <br />
                    <a href="<?php echo U('Travel/add','tag=story');?>"><h2>添加一条 艺术群 记录</h2></a>
                </div>
            </div>
        </div>
    </div>
