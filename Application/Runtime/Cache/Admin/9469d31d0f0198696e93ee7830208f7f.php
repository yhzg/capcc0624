...
<head>
    ...
    <script language="JavaScript" >
        ...
        function del(id)
        {
            ...
            if (confirm('确认删除?'))
            {
                document.location.href="<?php echo U('News/delete_picture_news');?>?newsid="+del_id;
            }
        }
        ...
        function edit(id)
        {
            ...
            if (confirm('跳转至编辑窗口？'))
            {
                document.location.href="<?php echo U('Manage/edit_picture_news');?>?newsid="+del_id;
            }
        }
    </script>
</head>
            ...
            <div id="form">
                    <table width="100%" style="text-align: center" >
                        <tr id="tr1" >
                            ...
                            <td width="11%" align="center">上传时间</td>
                ...
                <div style="font-size: 15px;margin-top: 20px">
                    ...
                    <br />
                    <br />
                    <a href="add_page"><h2>添加一条图说新闻</h2></a>
                </div>
            </div>
        </div>
    </div>
