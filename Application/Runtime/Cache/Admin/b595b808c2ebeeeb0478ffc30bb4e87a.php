...
<div id="mainDiv">
    ...
    <div id="centerDiv">
        <div id="left">
            ...
            <ul>
                <li ><a href="/capcc0624/admin.php/Index/index">添加首页新闻</a></li>
                <li ><a href="/capcc0624/admin.php/Manage/show_news_main_list">首页新闻列表</a></li>
                <li ><a href="#">菜单  3</a></li>
                <li ><a href="#">菜单  4</a></li>
                <li ><a href="#">菜单  5</a></li>
                <li ><a href="#">菜单  6</a></li>
        ...
        <div id="right">
            ...
            <div id="form">
                <form action="/capcc0624/admin.php/Manage/main_news" method="post" enctype="multipart/form-data">
                    <fieldset>
