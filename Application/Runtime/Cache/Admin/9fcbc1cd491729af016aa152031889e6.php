   ...
   <!-- <script type="text/javascript" src="/capcc0624/Public/Admin/nav.js"></script>-->
    ...
    <script language="JavaScript" >
        ...
        function del(id)
        {
            ...
            if (confirm('确认删除?'))
            {
                document.location.href="<?php echo U('Brand/delete_brand');?>?tag=product&id="+del_id;
            }
        }
        ...
        function edit(id)
        {
            ...
            if (confirm('跳转至编辑窗口？'))
            {
                document.location.href="<?php echo U('Brand/edit_brand');?>?tag=product&id="+del_id;
            }
        }
    </script>
</head>
...
<div id="mainDiv">
    <div id="centerDiv">
        ...
        <div id="right">
            <div id="current">&nbsp;&nbsp;&nbsp;&nbsp;当前位置:品牌 产品 列表</div>
            <div id="form">
                ...
                <div style="font-size: 15px;margin-top: 20px">
                    ...
                    <br />
                    <br />
                    <a href="<?php echo U('Brand/add','tag=product');?>"><h2>添加一条 产品</h2></a>
                </div>
            </div>
