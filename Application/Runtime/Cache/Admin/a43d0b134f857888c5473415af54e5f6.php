            ...
            <div id="form">
                <form action="/capcc0624/index.php/Admin/News/add_news/tag/<?php echo ($tag); ?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <legend style="font-size: 20px;">编辑新闻</legend>
                        ...
                        oriAuthor(原作者): <input type="text" name="oriAuthor" value='<?php echo ($list["oriauthor"]); ?>'  /><br />
                        Author(作者): <input type="text" name="author" value='<?php echo ($list["author"]); ?>'  /><br />
                        Editor(编辑): <input type="text" name="editor"  value='<?php echo ($list["editor"]); ?>'  /><br />
                        Source(来源): <input type="text" name="source" value='<?php echo ($list["source"]); ?>'  /><br />
