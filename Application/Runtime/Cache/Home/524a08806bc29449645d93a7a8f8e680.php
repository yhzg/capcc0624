	 				 			...
	 				 			<fieldset>
                                    ...
                                    <div>
	      						    ...
	      						    <div class="control-group" >
                                        <table  border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                              <td ><img id="imgcode"src="/capcc0624/index.php/Common/verify_code" onclick="this.src=this.src+'/'+Math.random()" alt="" name="" width="100" height="50" style="background-color: #FFFFFF" /></td>
	       							...
	       							<div class="form-action side" >
	            						<button type="submit" class="btn btn-danger  btn-lg " id="reg_submit">同意协议并注册</button>
