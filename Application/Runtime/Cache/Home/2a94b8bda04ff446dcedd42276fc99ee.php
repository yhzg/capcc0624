        ...
        <div id="home_page_roll" style="float:left; margin-left:25px; overflow:hidden; width:795px;">
            ...
            <div id="home_page_roll_img_1">
                <!--news_active表中level=4的共18行-->
                 <?php $__FOR_START_21351__=1;$__FOR_END_21351__=18;for($i=$__FOR_START_21351__;$i < $__FOR_END_21351__;$i+=1){ if(is_array($list12)): $i = 0; $__LIST__ = $list12;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><span id="small_img_<?php echo ($i); ?>">
                        ...
                        <tr>
                            <td id="gpic1">
                                <table border="0" align="center" cellpadding="0" cellspacing="0" style="float: left; width: 300px;">
                                    <!--循环输出滚动的图片-->
                                    <?php $__FOR_START_5396__=1;$__FOR_END_5396__=8;for($i=$__FOR_START_5396__;$i < $__FOR_END_5396__;$i+=1){ ?><tr>
