	   		  	...
	   		  	<div class="col-md-12">
	                    ...
	                    <br />
	        	        		...
	        	        		<!--div class="col-md-5 col-md-offset-1"-->
                                      ...
                                      <a href="<?php echo U('Pwd/forget_pwd');?>"><button type="button" class="btn btn-success btn-lg side" style="color:white;background-color:red;border-color:red">找回密码</button></a>
                                      <!--</a>&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:red" href="<?php echo U('Pwd/forget_pwd');?>">找回密码</a>-->
	        	        		<!--/div--> 
	        						</div>
